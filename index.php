    ...
    <div id="footerInside">
        ...
        <div id="contacts">
            <div class="contactWrap">
                <img src="images/envelope.svg" class="contactIcon" alt="картинка">
                info@brandshop.ru
            </div>
            <div class="contactWrap">
                <img src="images/phone-call.svg" class="contactIcon" alt="картинка">
                8 800 555 00 00
            </div>
            <div class="contactWrap">
                <img src="images/placeholder.svg" class="contactIcon" alt="картинка">
        ...
        <div id="social">
            <img class="socialItem" src="images/vk-social-logotype.svg" alt="картинка">
            <img class="socialItem" src="images/google-plus-social-logotype.svg" alt="картинка">
            <img class="socialItem" src="images/facebook-logo.svg" alt="картинка">
        </div>
